...
svt::cu_short command_create_algebraic_book = put_index_running(false);
...
svt::cu_short command_create_page = put_index_running(false);

svt::cu_short command_error_list = put_index_running(false);
