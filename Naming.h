...
#define program_version_publication L"5build"
...
#define error_list_window_name program_name L" — list of error"

#define algebraic_book_create_class_name L"Algebraic book create window"
