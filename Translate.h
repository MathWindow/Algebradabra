...
namespace translate {
	...
	c_string_param string_view_ = put_index_counter<string_param>(continue_counting);
	...
	c_string_param string_errors_list_window = put_index_counter<string_param>(continue_counting);
	c_string_param string_create_algebraic_book_window = put_index_counter<string_param>(continue_counting);
